...
export const content: ContentConfig = {
  ...
  colors: {
    primary: '#4DE03B',      // Cor principal (Botões, destaques, ícones)
    primaryDark: '#ffffffff',  // Cor principal escura (Hover)
    primaryHighlight: '#4DE03B', // Cor para textos destacados e ícones soltos (Pode ser igual a primary ou ajustada)
  ...
  infos: {
    ...
    phone: "(43) 3029-4053",
    whatsapp: "554330294053", // Apenas números, com código do país (55) e DDD
    email: "contato@fitnessacademia.com.br",
    address: "R. Vitória-Régia, 15 - Ouro Branco, Londrina - PR",
    mapsLink: "https://maps.app.goo.gl/FhF9fuWVjQzrBWeP7", // Link para abrir no Google Maps
    // Iframe do Google Maps (Copiar do Google Maps -> Compartilhar -> Incorporar um mapa)
    mapsEmbed: "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3662.841185773929!2d-51.1494901!3d-23.3577676!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94eb42e5426e0605%3A0xf41ab0b279fac93e!2sFitness%20Academia!5e0!3m2!1spt-BR!2sbr!4v1764603773159!5m2!1spt-BR!2sbr",
  },
  ...
  banner: {
    ...
    message: "PROMOÇÃO DE FIM DE ANO | 30% de Desconto no Plano Anual por Tempo Limitado!",
  ...
  hero: {
    enabled: true,
    badge: "Ouro Branco, Londrina/PR", //Nova unidade aberta"
    headline: {
  ...
  stats: {
    ...
    items: [
      {
        value: "4.9/5.0",
        label: "+240 Avaliações no Google",
  ...
  team: {
    ...
    members: [
      ...
      {
        name: "Bruno Santos",
        role: "Mestre de Muay Thai e Jiu Jitsu",
        image: images.team1,
        instagram: "#"
      },
      {
        name: "Júlia Lima",
        role: "Professora de Fit Dance e Zumba",
        image: images.team4,
        instagram: "#"
      }
    ]
    ...
    plans: [
      {
        ...
        price: '69,90',
        period: '/mês',
        features: ['Acesso total', 'Menor preço garantido', 'Parcelado 12x', 'Fidelidade 12 meses'],
        highlighted: true,
        badgeText: "MAIS ESCOLHIDO",
        discountText: "30% de desconto",
        buttonText: "Quero o Anual",
        whatsappMessage: "Olá, quero informações sobre o plano Flex Anual."
      },
      {
        name: 'Fitness Anual Recorrente',
        price: '79,90',
        period: '/mês',
        features: ['Acesso total', 'Sem boleto', 'Cobrança automática', 'Fidelidade 12 meses'],
        highlighted: false,
        badgeText: null,
        discountText: "-20% no anual recorrente",
        buttonText: "Quero o Anual Recorrente",
        whatsappMessage: "Olá, quero informações sobre o plano Flex Anual Recorrente."
      },
      {
        name: 'Fitness Semestral',
        price: '89,90',
        period: '/mês',
        features: ['Acesso total', 'Economia garantida', 'Parcelado 6x', 'Fidelidade 6 meses'],
        highlighted: false,
        badgeText: null,
        discountText: "-10% no semestre",
        buttonText: "Quero o Semestral",
        whatsappMessage: "Olá, quero informações sobre o plano Flex Semestral."
      },
      {
        name: 'Fitness Mensal',
        price: '99,90',
        period: '/mês',
        features: ['Acesso total', 'Sem fidelidade', 'Renovação mensal', 'Pagamento flexível'],
        highlighted: false,
        badgeText: null,
        discountText: null,
        buttonText: "Quero o Mensal",
        whatsappMessage: "Olá, tenho interesse no plano Flex Mensal."
      }
    ]
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Nos planos Fitness Anual e Fitness Semestral, você pode levar um convidado até 2 vezes por mês para treinar com você.',
      },
      {
  ...
  footer: {
    ...
    socialLinks: {
      instagram: "https://www.instagram.com/fitnessourobranco",
      facebook: "https://www.facebook.com/p/fitnessourobranco",
      youtube: "https://youtube.com/fitnessourobranco"
    },
    quickLinks: [
      { label: 'Início', href: '#hero' },
